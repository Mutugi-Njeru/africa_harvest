...
const CreateTrainerModal = ({ isOpen, onClose }) => {
  ...
  //filter this to get only users who are ward coordinators
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        const errorMessage =
          error.response.data.message || "Trainer creation failed";
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-saveButton focus:outline-none focus:ring-1 focus:ring-gray-100"
                required
              />
            </div>
            ...
            {/* pending update after clarification */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Status
              </label>
