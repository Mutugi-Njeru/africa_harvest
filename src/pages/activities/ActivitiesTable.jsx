...
const ActivitiesTable = ({
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, showActivities, itemsPerPage]);
      ...
      <div className="relative overflow-x-auto mt-3">
          ...
          <div className="border border-gray-200 flex items-center justify-between p-1 rounded-lg bg-gray-50">
            <button
              ...
              className={`mr-2 text-base font-bold rounded-md px-5 py-2 text-gray-700 hover:bg-gray-100 focus:text-white focus:bg-green-400 shadow-sm ${
                showActivities ? "text-white bg-green-400" : "bg-transparent"
              }`}
            >
              Value Chain Types
            </button>
            <button
              ...
              className={`text-base font-bold rounded-md px-5 py-2 text-gray-700 hover:bg-gray-100 focus:text-white focus:bg-green-400 transition-colors shadow-sm ${
                !showActivities ? "text-white bg-green-400" : "bg-transparent"
              }`}
            >
              Value Chain
        ...
        {isLoading ? (
          ...
          <div className="relative overflow-x-auto">
                  ...
                  <table className="w-full text-xs text-left rtl:text-right text-gray-500">
                    <thead className="text-xs text-gray-500 border-b bg-white">
                      <tr>
                        ...
                        <th className="px-3 py-2">Value Chain Type</th>
                    ...
                    <tbody>
                      {currentActivities.map((activity, index) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-1">{activity.description}</td>
                          <td className="px-3 py-1">{activity.createdAt}</td>
                          ...
                          <td className="flex items-center px-3 py-1">
                            <a
                              ...
                              className="font-medium text-green-600 cursor-pointer hover:underline flex items-center mr-4"
                            >
                            ...
                            <a
                              ...
                              className="font-medium text-red-600 cursor-pointer hover:underline flex items-center"
                            >
                    ...
                    <tbody>
                      {currentSubactivities.map((subactivity, index) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-1">{subactivity.createdAt}</td>
                          <td className="px-3 py-1 truncate max-w-[150px]">
                            {subactivity.updatedAt}
                          </td>
                          <td className="flex items-center px-3 py-1">
                            <a className="font-medium text-green-600 cursor-pointer hover:underline flex items-center mr-4">
                              <Edit className="h-4 w-4 mr-1" />
                              Edit
                            </a>
                            <a
            ...
            {/* Pagination Controls - Now directly after table like GroupsTable */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 shadow-lg rounded-lg max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete this value chain type?
            </p>
      ...
      {showDeleteSubActivityModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 shadow-lg rounded-lg max-w-md w-full mx-4">
            <h2 className="text-lg font-semibold mb-2">Confirm Delete</h2>
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete this value chain?
            </p>
            <div className="flex justify-end gap-3">
              <button
