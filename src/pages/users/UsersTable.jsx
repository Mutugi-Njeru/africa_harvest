...
const UsersTable = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="relative overflow-x-auto">
        {showUsers ? (
          <div>
                ...
                {currentUsers.length > 0 ? (
                  currentUsers.map((user, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-1 truncate max-w-[200px]">
                        {user.firstName} {user.lastName}
                      </td>
                      {/* <td className="px-4 py-1 max-w-[200px] truncate">
                        {user.email}
                      </td> */}
                      <td className="px-4 py-1">{user.msisdn}</td>
                      <td
                        className="px-4 py-1 truncate max-w-[150px]"
                        title={user.roles.join(", ")}
                      >
                        {user.roles.join(", ")}
                      </td>
                      <td
                        className="px-4 py-1 truncate max-w-[200px]"
                      ...
                      {(canEditUser || canDeleteUser) && (
                        <td className="flex items-center px-4 py-1">
                          {canEditUser && (
                            <>
                              <a
            ...
            {/* Users Pagination Controls - Directly under table */}
                ...
                {currentRoles.length > 0 ? (
                  currentRoles.map((role, index) => (
                    ...
                    >
                      <th
                        scope="row"
                        className="px-6 py-1 font-medium text-green-600 whitespace-nowrap"
                      >
                        {indexOfFirstRole + index + 1}
                      </th>
                      <td className="px-6 py-1 truncate max-w-[200px]">
                        {role.role}
                      </td>
                      <td className="px-6 py-1 max-w-[150px] truncate">
                        {role.description}
                      </td>
                      <td className="px-6 py-1 max-w-[150px] truncate">
                        {role.createdAt}
                      </td>
                      <td className="px-6 py-1 truncate max-w-[150px]">
                        {role.updatedAt}
                      </td>
                      <td className="px-6 py-1 truncate max-w-[200px]">
                        Active
            ...
            {allRoles.length > 0 && (
              <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-2 sm:px-6 mt-4">
                ...
                <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                  <div className="flex items-center gap-4">
                    <p className="text-sm text-gray-700">
                      Showing {allRoles.length > 0 ? indexOfFirstRole + 1 : 0} to{" "}
                      {Math.min(indexOfLastRole, allRoles.length)} of{" "}
      ...
      {/* Modals - Updated to match AccountTable design */}
      {showDeactivateModal && (
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 border-2 border-red-500 rounded-md px-6 py-2 min-w-[120px] bg-red-100 text-red-500 hover:bg-gray-50"
              >
                <Trash2 size={20} />
                Delete
              </button>
