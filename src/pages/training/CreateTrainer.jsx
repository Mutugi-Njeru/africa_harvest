      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="block w-full px-3 py-2 border border-gray-300 focus:border-yellow-300 focus:outline-none focus:ring-1 focus:ring-yellow-300"
              required
            />
          </div>
        ...
        <div className="flex justify-end gap-2">
          <button
            type="button"
            onClick={resetForm}
            className="px-4 py-2.5 bg-red-400 hover:bg-red-600 text-white rounded-md transition-colors"
            disabled={loading}
          >
            Reset
          </button>
          <button
            type="submit"
            className="px-4 py-2.5 bg-green-400 text-white hover:bg-green-700 rounded-md transition-colors disabled:bg-green-300 disabled:cursor-not-allowed"
            disabled={loading}
          >
