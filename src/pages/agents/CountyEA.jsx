                ...
                {currentItems.length > 0 ? (
                  currentItems.map((coordinator, index) => (
                    <tr key={coordinator.user.userId} className="bg-white border-b hover:bg-gray-50">
                      ...
                      <td className="px-3 py-1 max-w-[250px] truncate" title={getCountiesNames(coordinator.counties)}>
                  ...
                  <tr className="bg-white border-b hover:bg-gray-50">
                    <td colSpan="9" className="px-3 py-8 text-center text-gray-500">
                      {searchTerm ? 'No coordinators match your search' : 'No county coordinators found'}
                    </td>
                  </tr>
                )}
              </tbody>
